...
import org.jhipster.blog.repository.FaltaRepository;
...
public class FaltaResourceIntTest {
    ...
    public void createFalta() throws Exception {
        ...
        assertThat(testFalta.getDescricao()).isEqualTo(DEFAULT_DESCRICAO);
    }
    ...
    public void updateFalta() throws Exception {
        ...
        assertThat(testFalta.getDescricao()).isEqualTo(UPDATED_DESCRICAO);
    }
