...
import org.jhipster.blog.repository.ProfessorRepository;
...
public class ProfessorResourceIntTest {
    ...
    public void createProfessor() throws Exception {
        ...
        assertThat(testProfessor.getDescricao()).isEqualTo(DEFAULT_DESCRICAO);
    }
    ...
    public void updateProfessor() throws Exception {
        ...
        assertThat(testProfessor.getDescricao()).isEqualTo(UPDATED_DESCRICAO);
    }
