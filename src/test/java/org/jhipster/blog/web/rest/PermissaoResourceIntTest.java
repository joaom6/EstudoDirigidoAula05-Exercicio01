...
import org.jhipster.blog.repository.PermissaoRepository;
...
public class PermissaoResourceIntTest {
    ...
    public void createPermissao() throws Exception {
        ...
        assertThat(testPermissao.getDescricao()).isEqualTo(DEFAULT_DESCRICAO);
    }
    ...
    public void updatePermissao() throws Exception {
        ...
        assertThat(testPermissao.getDescricao()).isEqualTo(UPDATED_DESCRICAO);
    }
