...
import org.jhipster.blog.repository.NotaRepository;
...
public class NotaResourceIntTest {
    ...
    public void createNota() throws Exception {
        ...
        assertThat(testNota.getDescricao()).isEqualTo(DEFAULT_DESCRICAO);
    }
    ...
    public void updateNota() throws Exception {
        ...
        assertThat(testNota.getDescricao()).isEqualTo(UPDATED_DESCRICAO);
    }
