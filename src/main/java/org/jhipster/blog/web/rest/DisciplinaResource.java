...
public class DisciplinaResource {
    ...
    @Timed
    public List<Disciplina> getAllDisciplinas(@RequestParam(required = false, defaultValue = "false") boolean eagerload) {
    ...
    public ResponseEntity<Disciplina> getDisciplina(@PathVariable Long id) {
        ...
        Optional<Disciplina> disciplina = disciplinaRepository.findOneWithEagerRelationships(id);
